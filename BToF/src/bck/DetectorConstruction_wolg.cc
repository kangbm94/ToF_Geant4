...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
#include "DetectorConstruction_wolg.hh"
...
#include "MPPCSD.hh"
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
	DetectorConstruction_wolg::DetectorConstruction_wolg()
...
G4VPhysicalVolume* DetectorConstruction_wolg::Construct()
{
	...
	for(int i=0;i<8;i++)
	{
		...
		new G4PVPlacement(0,G4ThreeVector(mppc_posx[i],-window_posy,-mppc_posz),window_log,"window",expHall_log,false,0);
		new G4PVPlacement(0,G4ThreeVector(mppc_posx[i],-mppc_posy,-mppc_posz),MPPC_log,"mppc",expHall_log,false,0);
		new G4PVPlacement(0,G4ThreeVector(mppc_posx[i],mppc_posy,-mppc_posz),MPPC_log,"mppc",expHall_log,false,0);
	}
